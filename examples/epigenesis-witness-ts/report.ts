...
export function renderReport(report: WitnessReport): string {
  const chain = [
    ["01", "Acquired", report.identity.sourceSha256, `Recorded browser ${report.acquisition.browserSessionId}`],
